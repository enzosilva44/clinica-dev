    ...
    return (
      <div className="max-w-3xl mx-auto p-6">
        ...
        <input
          ...
          className="w-full border border-[#E5D8C5] rounded-xl px-4 py-3 text-sm mb-5 focus:outline-none focus:ring-2 focus:ring-[#00704A]/20"
        />

        <div className="space-y-3">
          {editing.questions.map((q, idx) => (
            <div key={q.id} className="bg-[#FAF7F2] border border-[#E5D8C5] rounded-xl p-4">
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    <select
                      ...
                      className="border border-[#E5D8C5] rounded-lg px-2 py-1.5 text-xs bg-white"
                    >
                  ...
                  {q.type === "choice" && (
                    <input
                      ...
                      className="w-full border border-[#E5D8C5] rounded-lg px-3 py-2 text-xs bg-white focus:outline-none focus:ring-2 focus:ring-[#00704A]/20"
                    />
                  )}
                </div>
              </div>
        ...
        <div className="flex justify-end gap-2 mt-6">
          <button onClick={() => setEditing(null)} className="text-sm text-gray-500 px-4 py-2 rounded-xl hover:bg-[#FAF7F2] transition">Cancelar</button>
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <div className="space-y-2">
        {templates.map((t) => (
          <div key={t.id} className="bg-white border border-[#EFE7DA] rounded-xl px-4 py-3 flex items-center justify-between">
            <div>
