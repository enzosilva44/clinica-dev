  ...
  return (
    <MainLayout>
      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-[#314D3E]">Procedimentos</h1>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center">
          <Stethoscope size={48} className="text-[#D6C1A3] mb-4" />
          <h2 className="text-xl font-semibold text-[#314D3E] mb-2">Nenhum procedimento cadastrado</h2>
          ...
          {procedures.map((procedure) => (
            <div key={procedure.id} className="bg-[#FAF7F2] border border-[#E5D8C5] rounded-2xl p-5">
              ...
              <div className="flex items-start justify-between">
                <div>
                  <h2 className="text-lg font-bold text-[#314D3E]">{procedure.name}</h2>
                  <p className="text-sm text-gray-500 mt-1">{procedure.category}</p>
                </div>
                <div className="flex gap-3">
                  <button onClick={() => handleEdit(procedure)} className="text-[#314D3E] hover:text-[#465634]">
                    <Pencil size={16} />
                  </button>
                  <button onClick={() => handleDuplicate(procedure)} className="text-gray-400 hover:text-[#314D3E]">
                    <Copy size={16} />
                  </button>
                  <button
              ...
              {/* PRODUTOS */}
              <div className="mt-5">
                <h3 className="font-semibold text-[#314D3E] mb-2">Produtos:</h3>
            ...
            <div className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-semibold text-[#314D3E]">Produtos utilizados</h3>
                  <button
                    type="button"
                    onClick={addProduct}
                    className="bg-[#314D3E] text-white px-3 py-2 rounded-lg text-sm"
                  >
                    + Produto
                  </button>
                </div>
                  ...
                  {selectedProducts.map((item, index) => (
                    <div key={index} className="grid grid-cols-12 gap-3">
                      ...
                      <input
                        ...
                        placeholder="Qtd"
                        className="col-span-2 border border-[#D6C1A3] rounded-xl p-3"
                      />
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-60 p-6">
          <div className="bg-white rounded-2xl w-full max-w-md p-6">
            <h2 className="text-2xl font-bold text-[#314D3E] mb-3">Excluir procedimento</h2>
