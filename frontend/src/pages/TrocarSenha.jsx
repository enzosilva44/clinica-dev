...
export default function TrocarSenha() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F2F0EB] px-4">
      <div className="bg-white rounded-2xl border border-[#E6E2D8] shadow-sm w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={saving}
            className="w-full bg-[#00704A] hover:bg-[#1E3932] text-white text-sm font-semibold py-3 rounded-xl transition disabled:opacity-50">
